...
FastAPI(Director)가 사용자와의 실시간 대화를 처리하고, 무거운 작업은 NanoClaw(Artisan)로 fire-and-forget 위임한다. Frontend는 Dumb UI로서 렌더링만 담당한다.

배포 컴포넌트는 3개: **FastAPI**, **NanoClaw**, **Frontend**.
